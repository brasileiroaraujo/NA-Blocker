...
public abstract class AbstractFastMetablocking extends AbstractFastEfficiencyMethod {
    ...
    public HashSet<Integer> counter_a_set = new HashSet<Integer>();
    public int counter_b = 0;
    public HashSet<Integer> counter_b_set = new HashSet<Integer>();
    ...
    public AbstractFastMetablocking(String nm, WeightingScheme wScheme) {
        ...
        retainedNeighbors = new ArrayList<Integer>();
...
//                }
            ...
            case FISHER_ENTRO:
                ...
                int a_f = (entityIndex.getNoOfEntityBlocks(entityId, 0)) - ab_f;
                int b_f = (entityIndex.getNoOfEntityBlocks(neighborId, 0)) - ab_f;
                counter_tot++;
                if (ab_f < 1) {
                    System.out.println("ab < 1");
                }
                ...
                vE_f[1] = entityIndex.getNoOfEntityBlocks(entityId, 0) - vE_f[0];
                v_E_f[0] = entityIndex.getNoOfEntityBlocks(neighborId, 0) - vE_f[0];
